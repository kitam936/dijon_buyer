    ...
    <div class="py-6 border">
        <div class=" mx-auto sm:px-4 lg:px-4 border ">
            <table class="md:w-2/3 bg-white table-auto text-center whitespace-no-wrap">
               <thead>
                    <tr>
                        <th class="w-2/12 md:px-4 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100"> 仕入先id</th>
                        <th class="w-4/12 md:px-4 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">仕入先名</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="w-2/12 md:px-4 py-1">{{ $vendor->id }}</td>
                        <td class="w-4/12 md:px-4 py-1"> {{ $vendor->vendor_name }}</td>
                        <td class="w-2/12 md:px-4 py-1"> {{ $vendor->vendor_info }}</td>
