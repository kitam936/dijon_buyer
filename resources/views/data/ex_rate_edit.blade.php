    ...
    <x-slot name="header">
        ...
        <div class="ml-2 mb-2 md:mb-0">
            ...
            <div class="ml-8 px-2 py-2 text-gray-900 ">
                ...
                <form method="POST" action="{{ route('data.ex_rate_update',['id'=>1]) }}">
                    @csrf
                    <div class="">
                    ...
                    <div class="mt-1 md:mt-8">
                        ...
                        <div class="flex pl-0  ml-2">
                            <x-label for="ex_rate" value="為替レート" class="mt-2"/>
                            <input type="number" class="w-40 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="ex_rate" value="{{ $ex_rate->ex_rate }}"></input>
                            <span class="mt-2">　※100現地通貨に対しての円</span>
                        </div>


                    </div>
                    <div class="flex pl-0 mt-2 ml-2 md:mt-2">
                        <x-label for="ex_memo" value="memo" />

                        <textarea class="pl-0 ml-8 text-sm md:ml-4 w-full md:w-1/2  border-gray-300 rounded" name="ex_memo" rows="5">{{ $ex_rate->ex_memo }}</textarea>
                    </div>
