<x-app-layout>
    <x-slot name="header">
        ...
        <div class="ml-2 md:ml-4">
            <button type="button" class="ml-2 mb-4 h-8 w-32 text-center text-sm text-white bg-indigo-500 border-0 py-1 px-2 focus:outline-none hover:bg-indigo-700 rounded " onclick="location.href='{{ route('hinban.hinban_index2') }}'" >商品</button>
        </div>

        </div>

        <form method="GET" action="{{ route('hinban_edit') }}" >
