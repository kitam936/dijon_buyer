<x-app-layout>
    <x-slot name="header">
        ...
        <form method="GET" action="{{ route('hinban_create') }}" >
            ...
            <div class="md:flex">
                ...
                <div class="relative ml-2 mr-0">
                    ...
                    <select  id="brand_id" name="brand_id"  class="w-28 bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" >
                        <option value="" @if(\Request::get('brand_id') == '0') selected  @endif >Brand選択</option>
                    ...
                    <div class="flex relative ">
                        ...
                        <div class="relative ml-2">
                            ...
                            <option value="" @if(\Request::get('unit_id') == '0') selected @endif >Unit選択</option>
                    ...
                    <div class="relative ml-2 mr-0">
                        ...
                        <option value="" @if(\Request::get('face_code') == '0') selected @endif >Face選択</option>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('hinban_store') }}" enctype="multipart/form-data">
                ...
                <div class="pl-0 mt-0 ml-2">
                    ...
                    <input type="hidden" readonly class="w-40 bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="vendor_id2" value="{{ \Request::get('vendor_id') }}"></input>
                </div>
                <div class="flex">
                <div class="pl-0 mt-0 ml-2">
                ...
                <div class="pl-0 mt-0 ml-2">
                    ...
                    <input class="w-40 bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="prod_code" value="{{ old('prod_code') }}"></input>
                </div>
                </div>
                <div class="pl-0 mt-2 md:mt-2 ml-2 ">
                    <x-label for="hinban_name" value="品名" />
                    <input class="w-full md:w-1/2 bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="hinban_name" value="{{ old('hinban_name') }}"></input>
                </div>

                <div class="ml-2">
                    <x-label for="hinban_info" value="Info" class="mt-1"/>
                    <x-textarea row="5" id="hinban_info" class="bg-gray-100 block mt-1 w-full" type="text" name="hinban_info" >{{ old('hinban_info')  }}</x-textarea>
                </div>
                <div class="pl-0 mt-0 ml-2">
                ...
                <div class="pl-0 mt-2 md:mt-2 ml-2 ">
                    ...
                    <input class="w-full md:w-1/2 bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="mix_rate" value="{{ old('mix_rate') }}"></input>
                </div>
                ...
                <div class="p-0 ml-2">
                    <div class="relative mt-2">
                        ...
                        <div class="pl-0 mt-0 md:mt-0 ml-2 ">
                            ...
                            <input class="w-20 h-10 bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="身幅"  name="width1" value="{{ old('width1') }}"></input>
                        </div>
                        </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="pl-0 mt-0 md:mt-0 ml-2 ">
                            {{-- <x-label for="length" value=" 着丈1" /> --}}
                            <input class="w-20 h-10 bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="着丈"  name="length2" value="{{ old('length2') }}"></input>
                        </div>
                        <div class="pl-0 mt-0 md:mt-0 ml-2 ">
                            {{-- <x-label for="width" value="身幅" /> --}}
                            <input class="w-20 h-10 bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="身幅"  name="width2" value="{{ old('width2') }}"></input>
                        </div>
                        </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="pl-0 mt-0 md:mt-0 ml-2 ">
                            {{-- <x-label for="length" value=" 着丈1" /> --}}
                            <input class="w-20 h-10 bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="着丈"  name="length3" value="{{ old('length3') }}"></input>
                        </div>
                        <div class="pl-0 mt-0 md:mt-0 ml-2 ">
                            {{-- <x-label for="width" value="身幅" /> --}}
                            <input class="w-20 h-10 bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="身幅"  name="width3" value="{{ old('width3') }}"></input>
                        </div>
                        </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="pl-0 mt-0 md:mt-0 ml-2 ">
                            {{-- <x-label for="length" value=" 着丈1" /> --}}
                            <input class="w-20 h-10 bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="着丈"  name="length4" value="{{ old('length4') }}"></input>
                        </div>
                        <div class="pl-0 mt-0 md:mt-0 ml-2 ">
                            {{-- <x-label for="width" value="身幅" /> --}}
                            <input class="w-20 h-10 bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="身幅"  name="width4" value="{{ old('width4') }}"></input>
                        </div>
                        </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="pl-0 mt-0 md:mt-0 ml-2 ">
                            {{-- <x-label for="length" value=" 着丈1" /> --}}
                            <input class="w-20 h-10 bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="着丈"  name="length5" value="{{ old('length5') }}"></input>
                        </div>
                        <div class="pl-0 mt-0 md:mt-0 ml-2 ">
                            {{-- <x-label for="width" value="身幅" /> --}}
                            <input class="w-20 h-10 bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="身幅"  name="width5" value="{{ old('width5') }}"></input>
                        </div>
                        </div>
